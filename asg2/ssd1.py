...
def stereo_match(left_img, right_img, kernel, max_offset):
    ...
    print(kernel_half,h-kernel_half)
            ...
            for offset in range(max_offset):               
                ...
                for v in range(-kernel_half, kernel_half):
                    for u in range(-kernel_half, kernel_half):
                        ...
                        if y+v>=left.shape[0] or x+u>=left.shape[1]:
                            print(left.shape, right.shape,y+v,x+u,y,v)
    ...
    print(depth[0],(depth.dtype),depth[10])
    # exit()
    Image.fromarray(depth).save('depth.png')

if __name__ == '__main__':
    stereo_match('xid-14489712_1.jpg','xid-14489713_1.jpg',6,30) 
